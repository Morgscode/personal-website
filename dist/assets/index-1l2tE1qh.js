function pi(w, C) {
  for (var N = 0; N < C.length; N++) {
    ...
    if (typeof L != 'string' && !Array.isArray(L)) {
      for (const O in L)
        if (O !== 'default' && !(O in w)) {
          const B = Object.getOwnPropertyDescriptor(L, O);
          B &&
            Object.defineProperty(
              w,
              O,
              B.get ? B : { enumerable: !0, get: () => L[O] },
            );
        }
    }
  }
    ...
    (N.Controller.addOption = function (o, g) {
      ...
      (N.Scene = function (o) {
              ...
              Y(3, 'event fired:', Ce, te ? '->' : '', te || ''),
                be &&
                  be.forEach(function (De, We) {
                    (!me || me === De.namespace) &&
                      De.callback.call(u, new N.Event(Ce, De.namespace, u, te));
                  });
          ...
          (this.progress = function (X) {
            if (arguments.length) {
              ...
              if (
                ...
                De && xe !== R && (We('enter'), We(xe === S ? 'start' : 'end')),
                  We('progress'),
                  De && c !== R && (We(c === S ? 'start' : 'end'), We('leave'));
              }
              return u;
            } else return e;
          });
        ...
        u.on('shift.internal', function (X) {
          ...
          ((c === s && te) || (c === R && T.duration === 0)) && U(), te && pe();
        })
        ...
        (this.setPin = function (X, te) {
          var xe = { pushFollowers: !0, spacerClass: 'scrollmagic-pin-spacer' },
    ...
    var P = (N._util = (function (o) {
      ...
      (g.extend = function (I) {
        ...
        (g.isMarginCollapseType = function (I) {
          return (
            ['block', 'flex', 'list-item', 'table', '-webkit-box'].indexOf(I) >
            -1
          );
        });
      var T = 0,
...
var bt = Qt.exports;
const yi = gi(bt),
  Ti = pi({ __proto__: null, default: yi }, [bt]);
/*!
 * VERSION: 2.1.3
 * DATE: 2019-05-17
  ...
  Re = (function (w) {
    ...
    var y = [0, 0, 1, 1],
      ...
      m = (l.register = function (n, d, x, f) {
        for (
          ...
          for (
            J = z[q],
              K = f ? r('easing.' + J, null, !0) : O.easing[J] || {},
              ue = Q.length;
            --ue > -1;
    ...
    for (
      ...
      (s = S[R] + ',Power' + R),
        ...
        m(new l(null, null, 2, R), s, 'easeIn' + (R === 0 ? ',easeNone' : '')),
        m(new l(null, null, 3, R), s, 'easeInOut');
    (D.linear = O.easing.Linear.easeIn), (D.swing = O.easing.Quad.easeInOut);
    ...
    r('Ticker', function (n, d) {
      var x = this,
        ...
        ge = function (Ne) {
          ...
          lt > q && (f += lt - Q),
            ...
            (ht = x.time - Ie),
            (!J || ht > 0 || Ne === !0) &&
              (x.frame++, (Ie += ht + (ht >= ce ? 0.004 : ce - ht)), (Ye = !0)),
            Ne !== !0 && (he = ue(ge)),
      ...
      (s = O.Ticker.prototype = new O.events.EventDispatcher()),
      (s.constructor = O.Ticker);
    ...
    var ie = function () {
      u &&
        k() - re > 2e3 &&
        ((C || {}).visibilityState !== 'hidden' || !M.lagSmoothing()) &&
        M.wake();
    ...
    var Z = r(
        ...
        function (n, d, x) {
          if (
            (W.call(this, d, x), (this.render = Z.prototype.render), n == null)
          )
            ...
            : (C || (C = w.document),
              C
                ? C.querySelectorAll
                  ...
                  : C.getElementById(n.charAt(0) === '#' ? n.substr(1) : n)
                : n);
        });
    var ee = [],
      de = {},
      ...
      Ee = function (n) {
        for (var d = this._firstPT, x = 1e-6, f; d; )
          (f = d.blob
            ...
            : d.c * n + d.s),
            d.m
              ? (f = d.m.call(this._tween, f, this._target || d.t, this._tween))
              : f < x && f > -x && !d.blob && (f = 0),
      ...
      at = function (n, d, x, f, z, q, Q, K, J) {
        ...
        var ue = typeof n[d],
          he =
            ue !== 'function'
              ? ''
              : d.indexOf('set') || typeof n['get' + d.substr(3)] != 'function'
              ? d
              : 'get' + d.substr(3),
    ...
    (s._init = function () {
      ...
      if (
        ...
        for (J = this._firstPT; J; ) (J.s += J.c), (J.c = -J.c), (J = J._next);
            ...
            n > -B
              ...
              : n < 0 &&
                ...
                q === 0 &&
                  ...
                  (f._rawPrevTime = he = !d || n || Q === n ? n : B))),
            (!f._initted || (f._startAt && f._startAt.progress())) && (x = !0);
        ...
        if (!(f._time === z && !x)) {
          ...
          for (
            ...
            ue.f
              ...
              (ue = ue._next);
          f._onUpdate &&
            (n < 0 && f._startAt && n !== -1e-4 && f._startAt.render(n, !0, x),
    ...
    if (
      ...
      for (s in T)
        T[s].func || w.console.log('GSAP encountered missing dependency: ' + s);
    }
    return (u = !1), Z;
  })(Ge),
  Ue = Ge.GreenSockGlobals,
  Ut = Ue.com.greensock,
  wt = Ut.core.SimpleTimeline,
  it = Ut.core.Animation,
  rt = Ue.Ease;
Ue.Linear;
var xi = Ue.Power1,
  Mt = Ue.Power2;
  ...
  function () {
      ...
      T = function (e) {
        ...
        return function (k, re, W) {
          var ie = (W || r).length,
            ...
            Me;
          if (!le) {
            if (((Me = r.grid === 'auto' ? 0 : (r.grid || [1 / 0])[0]), !Me)) {
              for (
                pe = -1 / 0;
    ...
    return (
      ...
      (c.staggerFrom = function (e, r, y, l, D, m, $, I) {
        return (
          (y.runBackwards = !0), this.staggerTo(e, r, u(this, y), l, D, m, $, I)
        );
      }),
      ...
      (c._parseTimeOrLabel = function (e, r, y, l) {
        ...
        if (
          ...
          (r = parseInt(e.charAt(m - 1) + '1', 10) * Number(e.substr(m + 1))),
            (e = m > 1 ? this._parseTimeOrLabel(e.substr(0, m - 1), 0, y) : D);
        } else e == null && (e = D);
        return Number(e) + r;
      }),
      (c.seek = function (e, r) {
          ...
          (l._totalTime = l._time = m),
            l._reversed ||
              ...
              l._duration === 0 &&
                ...
                l._rawPrevTime !== e &&
                l._first &&
                ((le = !0), l._rawPrevTime > C && (ie = 'onReverseComplete'))),
            (l._rawPrevTime =
              l._duration || !r || e || l._rawPrevTime === e ? e : C),
            (e = m + 1e-4);
        else if (e < C)
          if (
              ...
              if (k._active || (k._startTime <= D && !k._paused && !k._gc)) {
                if (Z === k) {
                  for (Z = k._prev; Z && Z.endTime() > l._time; )
                    Z.render(
                      Z._reversed
                        ? Z.totalDuration() - (e - Z._startTime) * Z._timeScale
      ...
      (c.totalDuration = function (e) {
        if (!arguments.length) {
          if (this._dirty) {
            for (var r = 0, y = this, l = y._last, D = 999999999999, m, $; l; )
              (m = l._prev),
    ...
    return (
      ...
      (o.render = function (g, S, R) {
        ...
        var s = this,
          ...
          ie,
          le;
        if ((M !== s._time && (g += s._time - M), g >= u - C && g >= 0))
          s._locked || ((s._totalTime = u), (s._cycle = s._repeat)),
            s._reversed ||
              ...
              s._duration === 0 &&
                ...
                y !== g &&
                s._first &&
                ((k = !0), y > C && (Y = 'onReverseComplete'))),
            (s._rawPrevTime =
              s._duration || !S || g || s._rawPrevTime === g ? g : C),
            s._yoyo && s._cycle & 1
              ? (s._time = g = 0)
              : ((s._time = T), (g = T + 1e-4));
        else if (g < C)
          if (
            ...
            if (
              ((s._rawPrevTime = T || !S || g || s._rawPrevTime === g ? g : C),
              g === 0 && $)
            )
        ...
        if (
          ...
          for (
            ...
            (m._active || (m._startTime <= s._time && !m._paused && !m._gc)) &&
        ...
        s._onUpdate && (S || (L.length && O(), s._callback('onUpdate'))),
          Y &&
            (s._locked ||
              s._gc ||
      ...
      (g.render = function (u, T, c) {
            ...
            ? ((e._totalTime = r),
              ...
              m === 0 &&
                ...
                ($ < 0 ||
                  ...
                  ($ === O && e.data !== 'isPause')) &&
                  $ !== u &&
                  ((c = !0), $ > O && (Y = 'onReverseComplete')),
                (e._rawPrevTime = Z = !T || u || $ === u ? u : O)))
            : u < O
        ...
        for (
          e._lazy !== !1 && (e._lazy = !1),
            ...
            l === 0 &&
              ...
              e._startAt &&
                (u >= 0 ? e._startAt.render(u, !0, c) : Y || (Y = '_dummyGS')),
              e.vars.onStart &&
                (e._totalTime !== 0 || m === 0) &&
        ...
        e._onUpdate &&
          ...
          Y &&
            ...
            m === 0 && e._rawPrevTime === O && Z !== O && (e._rawPrevTime = 0));
      }),
      (L.to = function (u, T, c) {
        return new L(u, T, c);
      }),
 ...
 */ Ge._gsDefine(
  ...
  function () {
    ...
    var g = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
      ...
      te = (function () {
        ...
        return (
          ...
          (ot = Je && parseFloat(pe.substr(pe.indexOf('Version/') + 8, 2)) < 6),
        ...
        return (
          ...
          i == null
            ...
            : ((v = 360),
              ...
              (b =
                (j
                  ? parseInt(i.charAt(0) + '1', 10) * parseFloat(_[0].substr(2))
                  : parseFloat(_[0])) *
    ...
    (ge = new RegExp(ge + ')', 'gi')),
      ...
      Re.defaultStringFilter || (Re.defaultStringFilter = w.colorStringFilter);
        ...
        return j
          ? t
            ...
            : ((H = function (A) {
                ...
                return (
                  ((_ && A !== 'none' && A.substr(0, A.indexOf(ne[0]))) || _) +
                  ne.join(E) +
                  b
                );
              }),
    ...
    U._setPluginRatio = function (i) {
      ...
      for (
        var t = this.data, h = t.proxy, p = t.firstMPT, a = 1e-6, v, _, b, E, j;
        p;
      ...
      Rt = (w.parseComplex = function (i, t, h, p, a, v, _, b, E, j) {
        ...
        for (
          ...
          if (
            ...
            if (((we = oe.match(S)), !we || we.length !== ye.length)) return _;
            for (ae = 0, G = 0; G < ye.length; G++)
              (Fe = ye[G]),
                ...
                _.appendXtra(
                  ...
                  Q(we[G], Fe),
                  '',
                  ne && V.substr(Se + Fe.length, 2) === 'px' ? Math.round : !1,
                  G === 0,
                ),
                (ae = Se + Fe.length);
    ...
    var Ht = function (i, t) {
        (t = t || {}),
          ...
          (P[i] = P[this.p] = this),
          (this.format =
            t.formatter || Ne(t.defaultValue, t.color, t.collapsible, t.multi)),
    ...
    (o = Ht.prototype),
      (o.parseComplex = function (i, t, h, p, a, v) {
        ...
        if (
          ...
          for (F = j.length > E.length ? j.length : E.length, b = 0; b < F; b++)
            (t = E[b] = E[b] || this.dflt),
              (h = j[b] = j[b] || this.dflt),
              _ &&
                ((H = t.indexOf(_)),
      ...
      (o.parse = function (i, t, h, p, a, v, _) {
        return this.parseComplex(
          i.style,
          this.format(Ae(i, this.p, O, !1, this.dflt)),
          this.format(t),
          a,
          v,
        );
      ...
      oi = (function () {
        ...
        return (
          fe.createElementNS &&
            ...
            !i &&
            ((t = $t('svg', mt)),
            (h = $t('rect', t, { width: 100, height: 50, x: 100 })),
        ...
        U.setTransformRatio =
          function (i) {
            ...
            (Le = 1),
              ...
              (tt || A) &&
                (tt && ((j += we * -tt), (F += Se * -tt), (H += Le * -tt + tt)),
                A &&
                  ((j +=
                    t.xOrigin - (t.xOrigin * oe + t.yOrigin * ye) + t.xOffset),
                  (F +=
                    t.yOrigin - (t.xOrigin * ve + t.yOrigin * Te) + t.yOffset)),
                j < _e && j > -_e && (j = Qe),
                F < _e && F > -_e && (F = Qe),
                H < _e && H > -_e && (H = 0)),
              (ze =
    ...
    (o = Ft.prototype),
          ...
          parser: function (i, t, h, p, a, v, _) {
            ...
            if (
              ...
              (oe = ee.style),
                ...
                ae.indexOf('%') !== -1 &&
                  ((oe.width = Ae(i, 'width')), (oe.height = Ae(i, 'height'))),
                fe.body.appendChild(ee),
                (V = Ct(ee, null, !1)),
                G.skewType === 'simple' && (V.scaleY *= Math.cos(V.skewX * W)),
                G.svg &&
                  ((Te = G.xOrigin),
                  (Se = G.yOrigin),
                  (V.x -= G.xOffset),
                ...
                A.xPercent != null && (V.xPercent = K(A.xPercent, G.xPercent)),
                A.yPercent != null && (V.yPercent = K(A.yPercent, G.yPercent));
            ...
            return (
              ...
              G.svg &&
                ...
                (Te !== G.xOffset || Se !== G.yOffset) &&
                  ((a = Dt(G, 'xOffset', E ? Te : G.xOffset, G.xOffset, a, se)),
                  (a = Dt(G, 'yOffset', E ? Se : G.yOffset, G.yOffset, a, se))),
                (ae = '0px 0px')),
              (ae || (ft && ye && G.zOrigin)) &&
                (Ze
                  ? ((we = !0),
              ...
              we &&
                (p._transformType =
                  !(G.svg && pt) && (ye || this._transformType === 3) ? 3 : 2),
              b && (_.scale = b),
              a
            );
          },
        ...
        'borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius',
        {
          ...
          parser: function (i, t, h, p, a, v) {
            return Rt(
              i.style,
              h,
              this.format(Ae(i, h, O, !1, '0px 0px')),
              this.format(t),
              !1,
              '0px',
              a,
        ...
        parser: function (i, t, h, p, a, v) {
          ...
          return (
            X < 9
              ...
              : ((_ = this.format(Ae(i, this.p, O, !1, this.dflt))),
                (t = this.format(t))),
      ...
      Be('border', {
        ...
        parser: function (i, t, h, p, a, v) {
          var _ = Ae(i, 'borderTopWidth', O, !1, '0px'),
          ...
          return (
            ...
            this.parseComplex(
              ...
              this.format(
                _ +
                  ' ' +
                  Ae(i, 'borderTopStyle', O, !1, 'solid') +
                  ' ' +
                  Ae(i, 'borderTopColor', O, !1, '#000'),
              ),
              b.join(' '),
              a,
              v,
        ...
        formatter: function (i) {
          var t = i.split(' ');
          return (
            t[0] + ' ' + (t[1] || 'solid') + ' ' + (i.match(ge) || ['#000'])[0]
          );
        },
      }),
      Be('borderWidth', {
    ...
    Be('opacity,alpha,autoAlpha', {
      defaultValue: '1',
      parser: function (i, t, h, p, a, v) {
        var _ = parseFloat(Ae(i, 'opacity', O, !1, '1')),
          b = i.style,
          E = h === 'autoAlpha';
        return (
          typeof t == 'string' &&
            t.charAt(1) === '=' &&
            (t = (t.charAt(0) === '-' ? -1 : 1) * parseFloat(t.substr(2)) + _),
          E &&
            _ === 1 &&
            Ae(i, 'visibility', O) === 'hidden' &&
            t !== 0 &&
            (_ = 0),
          te
    ...
    (o = w.prototype),
      ...
      (o._onInitTween = function (i, t, h, p) {
        ...
        if (
          ...
          (A = new Ye(i, 'transform', 0, 0, null, 2)),
            ...
            (A.setRatio = Ze ? ui : fi),
            (A.data = this._transform || Ct(i, O, !0)),
            (A.tween = h),
            (A.pr = -1),
            B.pop();
        }
        ...
        if (
          ...
          for (; t; ) {
            if (
              ...
              t.type === -1 ? (t.t[t.p] = t.xs0) : t.setRatio && t.setRatio(i);
            t = t._next;
          }
        else
          for (; t; )
      ...
      (o._enableTransforms = function (i) {
        (this._transform = this._transform || Ct(this._target, O, !0)),
          (this._transformType =
    ...
    (o._addLazySet = function (i, t, h) {
      ...
      (p.e = h), (p.setRatio = di), (p.data = this);
    }),
 ...
 *
 * @author: Jack Doyle, jack@greensock.com
 */ var bi = Ge._gsDefine.plugin({
  propName: 'attr',
  API: 2,
  version: '0.6.1',
  init: function (w, C, N, L) {
    var O, B;
 ...
 **/ var Kt = Ge._gsDefine.plugin({
  ...
  Pi = function (w) {
    var C = w < 1 ? Math.pow(10, (w + '').length - 2) : 1;
    return function (N) {
      return ((Math.round(N / w) * w * C) | 0) / C;
    };
  },
  Si = function (w, C) {
    for (; w; ) !w.f && !w.blob && (w.m = C || Math.round), (w = w._next);
  },
  Jt = Kt.prototype;
Jt._onInitAllProps = function () {
  var w = this._tween,
    C = w.vars.roundProps,
    N = {},
    ...
    P,
    o;
  if (typeof C == 'object' && !C.push) for (o in C) N[o] = Pi(C[o]);
  else
    for (typeof C == 'string' && (C = C.split(',')), P = C.length; --P > -1; )
      N[C[P]] = Math.round;
  for (o in N)
    for (O = w._firstPT; O; )
      (B = O._next),
        O.pg
          ...
          : O.n === o &&
            (O.f === 2 && O.t
              ? Si(O.t._firstPT, N[o])
              : (this._add(O.t, o, O.s, O.c, N[o]),
                B && (B._prev = O._prev),
                O._prev
                  ? (O._prev._next = B)
                  : w._firstPT === O && (w._firstPT = B),
                (O._next = O._prev = null),
                (w._propLookup[o] = L))),
        (O = B);
  return !1;
};
Jt._add = function (w, C, N, L, O) {
  this._addTween(w, C, N, N + L, C, O || Math.round),
 ...
 *
 * @author: Jack Doyle, jack@greensock.com
 **/ var ei = Ge._gsDefine.plugin({
  propName: 'directionalRotation',
  version: '0.3.1',
  API: 2,
  init: function (w, C, N, L) {
    typeof C != 'object' && (C = { rotation: C }), (this.finals = {});
    var O = C.useRadians === !0 ? Math.PI * 2 : 360,
      B = 1e-6,
      P,
      o,
      g,
      ...
      P !== 'useRadians' &&
        ...
        (g = parseFloat(
          typeof w[P] != 'function'
            ? w[P]
            : w[
                P.indexOf('set') || typeof w['get' + P.substr(3)] != 'function'
                  ? P
                  : 'get' + P.substr(3)
              ](),
        )),
        ...
        s.length &&
          ((o = s.join('_')),
          o.indexOf('short') !== -1 &&
            ((R = R % O), R !== R % (O / 2) && (R = R < 0 ? R + O : R - O)),
          o.indexOf('_cw') !== -1 && R < 0
            ? (R = ((R + O * 9999999999) % O) - ((R / O) | 0) * O)
            : o.indexOf('ccw') !== -1 &&
              R > 0 &&
              (R = ((R - O * 9999999999) % O) - ((R / O) | 0) * O)),
        (R > B || R < -B) &&
  ...
  set: function (w) {
    ...
    if (w !== 1) this._super.setRatio.call(this, w);
      ...
      for (C = this._firstPT; C; )
        C.f ? C.t[C.p](this.finals[C.p]) : (C.t[C.p] = this.finals[C.p]),
          (C = C._next);
  },
});
ei._autoCSS = !0;
 ...
 **/ var Ri = 180 / Math.PI,
  ...
  Ai = function (w, C, N, L, O) {
    ...
    for (g = 0; g < B; g++)
      (M = w[P]),
        ...
        O
          ? ((y = gt[g]),
            (l = vt[g]),
            (D = ((l + y) * C * 0.25) / (L ? 0.5 : xt[g] || 0.5)),
            (u = R - (R - S) * (L ? C * 0.5 : y !== 0 ? D / y : 0)),
            (T = R + (s - R) * (L ? C * 0.5 : l !== 0 ? D / l : 0)),
    ...
    (M = w[P]),
      ...
      (M.ca = M.c - M.a),
      (M.ba = o - M.a),
      N && ((r = Gt(M.a, o, M.c, M.d)), w.splice(P, 1, r[0], r[1], r[2], r[3]));
  },
  ki = function (w, C, N, L) {
    var O = [],
      B,
    ...
    if (L)
      for (w = [L].concat(w), P = w.length; --P > -1; )
        typeof (R = w[P][C]) == 'string' &&
          R.charAt(1) === '=' &&
          (w[P][C] = L[C] + Number(R.charAt(0) + R.substr(2)));
    if (((B = w.length - 2), B < 0))
      return (O[0] = new St(w[0][C], 0, 0, w[0][C])), O;
    for (P = 0; P < B; P++)
      (o = w[P][C]),
        (g = w[P + 1][C]),
        (O[P] = new St(o, 0, 0, g)),
        N &&
          ...
          (gt[P] = (gt[P] || 0) + (g - o) * (g - o)),
          (vt[P] = (vt[P] || 0) + (S - g) * (S - g)));
    return (O[P] = new St(w[P][C], 0, 0, w[P + 1][C])), O;
  },
  ti = function (w, C, N, L, O, B) {
    var P = {},
      o = [],
      g = B || w[0],
      S,
      ...
      c,
      e;
    (O = typeof O == 'string' ? ',' + O + ',' : Ci), C == null && (C = 1);
  ...
  Ei = function (w, C, N) {
    ...
    var L = {},
      ...
      e,
      r;
    if ((B && N && (w = [N].concat(w)), w == null || w.length < O + 1))
  ...
  Mi = function (w, C, N) {
    for (
      var L = 1 / N, O = w.length, B, P, o, g, S, R, s, M, u, T, c;
      --O > -1;
  ...
  yt = Ge._gsDefine.plugin({
    ...
    init: function (w, C, N) {
      (this._target = w),
        ...
        (this._props = []),
        (this._timeRes =
          C.timeResolution == null ? 6 : parseInt(C.timeResolution, 10));
      var L = C.values || [],
        O = {},
        B = L[0],
        P = C.autoRotate || N.vars.orientToBezier,
        o,
        g,
        S,
        R,
      ...
      for (S = this._props.length; --S > -1; )
        (o = this._props[S]),
          ...
          (O[o] = g
            ? w[
                o.indexOf('set') || typeof w['get' + o.substr(3)] != 'function'
                  ? o
                  : 'get' + o.substr(3)
              ]()
            : parseFloat(w[o])),
      ...
      if (
        ((this._beziers =
          C.type !== 'cubic' && C.type !== 'quadratic' && C.type !== 'soft'
            ? ti(
                L,
                isNaN(C.curviness) ? 1 : C.curviness,
                !1,
                C.type === 'thruBasic',
                C.correlate,
                s,
        ...
        var M = Di(this._beziers, this._timeRes);
...
yt._autoCSS = !0;
yt.quadraticToCubic = function (w, C, N) {
  return new St(w, (2 * C + w) / 3, (2 * C + N) / 3, N);
};
...
ii._mod = function (w) {
  for (var C = this._overwriteProps, N = C.length, L; --N > -1; )
    (L = w[C[N]]), L && typeof L == 'function' && (this._mod[C[N]] = L);
};
ii._kill = function (w) {
  var C = this._props,
    N,
  ...
  for (N in this._beziers)
    if (N in w)
      for (
        delete this._beziers[N], delete this._func[N], L = C.length;
        --L > -1;

      )
        C[L] === N && C.splice(L, 1);
  if (((C = this._autoRotate), C))
    for (L = C.length; --L > -1; ) w[C[L][2]] && C.splice(L, 1);
          ...
          (o.removeTween = function (s) {
            return (
              g &&
                ...
                g.kill(),
                (g = void 0),
                S(3, 'removed tween (reset: ' + (s ? 'true' : 'false') + ')')),
              o
            );
          });
      });
  },
  Ui = { ScrollMagicPluginGsap: Gi };
Ui.ScrollMagicPluginGsap(Ti, Wt, Pt);
...
function Hi() {
  ...
  N &&
    N.forEach((O) => {
      ...
      new bt.Scene({ triggerElement: O, triggerHook: 0.7, reverse: !0 })
        .setTween(B)
        .addTo(Lt);
    });
  ...
  window.innerWidth >= 576 &&
    L.forEach((O) => {
      O = Wi(O);
      const B = O.querySelectorAll('span'),
        P = new Pt();
      P.staggerFromTo(
        B,
        0.35,
        ...
        new bt.Scene({ triggerElement: O, triggerHook: 0.7, reverse: !1 })
          .setTween(P)
          .addTo(Lt);
    });
}
function Vi() {
  const w = document.querySelectorAll('.personal-project'),
    C = document.querySelectorAll('.project-slide'),
...
const ri = document.querySelector('.nav__container'),
  $i = document.querySelector('.nav__button'),
  Zi = document.querySelector('.nav__close'),
  Qi = () => {
    ri.classList.add('nav__active');
  },
  Ki = () => {
    ri.classList.remove('nav__active');
  };
function Ji() {
  $i.addEventListener('click', Qi), Zi.addEventListener('click', Ki);
}
function er(w) {
  w.forEach((C) => {
    C.intersectionRatio > 0 &&
      ((C.target.src = C.target.dataset.src),
      setTimeout(function () {
        C.target.classList.add('visible');
      }, 300),
      ni.unobserve(C.target));
  });
}
const ni = new IntersectionObserver(er, { rootMargin: '100px', threshold: 0 });
function tr() {
...
function ir() {
  ...
  w.disabled = !0;
  const C = document.querySelector('#portfolioContactForm');
...
function rr(w) {
  const C = new FormData(w);
  let N = new Object();
  return C.forEach((O, B) => (N[B] = O)), JSON.stringify(N);
}
function nr() {
  const w = document.querySelector('#portfolioContactSubmit');
  w && w.addEventListener('click', ir);
}
